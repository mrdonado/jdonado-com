...
- Spend a few minutes ideally each day reviewing your flashcards in Anki. Anki will only show them when it calculates that you need a refresh, so most days you won't have a lot of cards, and the number will decrease over time (unless you keep adding new ones at a faster pace!). Find out how many cards you can handle each day without feeling overwhelmed and adjust the number of new cards you add each week accordingly. You can also configure Anki to limit the number of new cards per day. The default limit is 20, which means that you can add hundreds of cards at once and Anki will only show you 20 new cards each day. I'd recommend to start with a lower number, like 5 or 10, and increase it as you get used to the process. Make sure to activate badges in Anki, as they can be a great motivator (again, Inbox Zero-like).

Even five minutes a day can make a significant difference. I do this when having a coffee in the morning, and while waiting in lines, making it a nice alternative to mindless scrolling.
