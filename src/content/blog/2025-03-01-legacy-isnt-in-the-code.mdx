...
Because if we don’t challenge it, we’ll just keep using `goto`—until, eventually, a new generation ([or an AI](https://www.jdonado.com/post/2025-02-05-will-ai-replace-us-all/)...) comes along and replaces us.
