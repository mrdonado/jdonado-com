...
description: 'An AI Software Searching for Solutions to Healthcare Problems'
pubDate: 'Sep 27 2017'
heroImage: '/src/assets/images/lifescope.jpg'
category: 'Labs'
tags: ['ai', 'architecture', 'product-development']
---

import { Image } from 'astro:assets'
import architectureDiagram from '/src/assets/images/lifescope-architecture.png'
