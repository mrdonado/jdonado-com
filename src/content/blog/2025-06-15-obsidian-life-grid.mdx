...
> An Obsidian plugin to visualize your entire life as an interactive grid, where each dot represents a day of your existence (whether it's real or simulated). - [Available in GitHub](https://github.com/mrdonado/obsidian-life-grid)
