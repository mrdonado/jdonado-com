...
1xComThread: 'https://x.com/jdonado/status/1881768257335779696?utm_source=comment&utm_medium=jdonado-com'
1linkedInThread: 'https://www.linkedin.com/posts/f-javier-r-donado_from-luck-to-skill-randomness-and-product-activity-7287183558824058882-cq3I?utm_source=comment&utm_medium=jdonado-com'
---
...
Also, don't forget that you're not alone. One of the lessons of Systems Thinking in an organization is that leadership is not so much about individuals but about the whole system. Try to influence the system to create momentum so that positive feedback loops make your job easier each time.
