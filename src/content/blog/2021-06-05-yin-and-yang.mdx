...
pubDate: 'Jun 05 2021'
heroImage: '/src/assets/images/yin-yang-2.jpeg'
category: 'Writing Software'
tags: ['productivity', 'product-development', 'architecture', 'coding']
---

import { Image } from 'astro:assets'
import graph from '/src/assets/images/speed-time-chart.png'
...
<Image src={graph} alt='Development speed vs. time since project start' />
